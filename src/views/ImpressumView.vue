<template>
	<v-container
		class="height-screen text-center">
		<v-row>
			<v-col cols="12">
				<h1>Impressum</h1>
			</v-col>
			<v-col cols="12">
				...
				<v-container>
					<v-row>
						<v-col cols="12">
							<p>AIRA Holding GmbH</p>
						</v-col>
						<v-col cols="12">
							<p>Hindenburgstraße 14</p>
						</v-col>
						<v-col cols="12">
							<p>77830 Bühlertal</p>
						</v-col>
					...
					<v-row>
						<v-col cols="12">
							...
							<v-btn
								...
								variant="text"
								href="mailto:info@aira-holding.de">
								info@aira-holding.de
							</v-btn>
						</v-col>
					</v-row>
				</v-container>
